...
public class GameActivity extends AppCompatActivity {
    ...
    public final static String TEAM_ONE_SCORE = "com.example.tabooo.TEAM_ONE_SCORE";
    public final static String TEAM_TWO_SCORE = "com.example.tabooo.TEAM_TWO_SCORE";
    public final static String TURN = "com.example.tabooo.TURN";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            in = new BufferedReader(new FileReader("basic_taboo_cards.txt"));
        }
        catch (FileNotFoundException exception) {
        }

        try {
            in = new BufferedReader(new FileReader("intermediate_taboo_cards.txt"));
        }
        catch (FileNotFoundException exception) {
        }
        ...
        int color = Color.parseColor("#9F9326"); // coloring the pause button
